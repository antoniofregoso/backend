...
Ejecuta estos comandos en otra terminal mientras los contenedores están corriendo:

1.  **Crear una nueva migración** (Ejecutar después de modificar modelos en `Models/`):
    ```bash
